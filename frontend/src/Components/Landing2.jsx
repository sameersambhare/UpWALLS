    ...
    return (
        <div className='w-full h-screen bg-black px-[4vw] py-[4vw] flex'>
            <div className="w-[50%] mt-[4vw]">
                <h1 style={{ backgroundImage: `url(${heading2})`, backgroundPosition: "center", backgroundSize: "cover" }} className='text-transparent bg-clip-text text-[4.5vw] tracking-tight font-bold leading-none'>Interaction design
                    in Play is easy,
                    powerful, and native.</h1>
            </div>
            <div className="w-[50%] mt-[4vw] px-[4vw] py-[2vw] flex gap-[2vw] flex-col">
